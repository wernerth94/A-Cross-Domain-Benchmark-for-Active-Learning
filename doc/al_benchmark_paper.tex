...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{img/oracle_performance.png}
	\caption{Performance drop for Oracle in late stages of Active Learning.}
\end{figure}
...
\begin{itemize}
	...
	\item The current sample of unlabeled points 
\end{itemize}
